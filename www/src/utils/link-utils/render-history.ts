        ...
        <div class="flex justify-between items-center">
          <div class="flex-1 overflow-hidden">
            <div class="flex items-center pb-1">
              <div class="pr-2 select-none cursor-pointer copy-button" data-string="${entry.shortUrl}" title="${localizedClickToCopy[locale]}">
            ...
            <div>
              <div class="flex items-center">
                <div class="pr-2 select-none">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 21V9a9 9 0 0 0 9 9"/></g></svg>
                </div>
